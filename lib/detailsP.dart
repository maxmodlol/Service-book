...
class _MyDetails extends State<details> {
  ...
  List<String> photos = ['images/plumb1.jpg', 'images/plumb2.jpg'];
  void _previousImage() {
    setState(() {
                      ...
                      Column(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Text(
                                Translations.of(context).plumber_des,
                                style: TextStyle(
                            ...
                            Padding(
                              ...
                              child: Text(
                                Translations.of(context).plumber_motiv,
                                style: TextStyle(
                                    fontFamily: 'Montserrat',
                                    fontSize: 25.0,
                                    color: Colors.black,

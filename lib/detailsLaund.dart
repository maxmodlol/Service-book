...
class Launddetails extends StatefulWidget {
  int id;
  var user;
  Launddetails(this.user, this.id);
  @override
  _MyDetails createState() => _MyDetails();
}

class _MyDetails extends State<Launddetails> {
  ...
  int photoIndex = 0;
  List<String> photos = ['images/laund1.jpg', 'images/laund.jpg'];
  void _previousImage() {
    setState(() {
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Text(
                                Translations.of(context).lunder_des,
                                style: TextStyle(
                            ...
                            Padding(
                              ...
                              child: Text(
                                Translations.of(context).lunder_motv,
                                style: TextStyle(
                                    fontFamily: 'Montserrat',
                                    fontSize: 25.0,
                                    color: Colors.black,

...
class Paintdetails extends StatefulWidget {
  var user;
  int id;
  Paintdetails(this.user, this.id);
  @override
  _paintDetails createState() => _paintDetails();
}

class _paintDetails extends State<Paintdetails> {
  int photoIndex = 0;
  ...
  List<String> photos = ['images/paint1.jpg', 'images/paint2.jpg'];
  void _previousImage() {
    setState(() {
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        Translations.of(context).cleaning_painting_des,
                        style: TextStyle(
                    ...
                    Padding(
                      ...
                      child: Text(
                        Translations.of(context).cleaning_painting_motv,
                        style: TextStyle(
                            fontFamily: 'Montserrat',
                            fontSize: 25.0,
                            color: Colors.black,
                    ...
                    Padding(
                        ...
                        child: FlatButton(
                          ...
                          child: Text(Translations.of(context).pickservice),

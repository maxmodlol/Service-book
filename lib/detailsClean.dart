...
class Cleandetails extends StatefulWidget {
  int id;
  var user;
  Cleandetails(this.user, this.id);
  @override
  _MyDetail createState() => _MyDetail();
}

class _MyDetail extends State<Cleandetails> {
  int photoIndex = 0;
  List<String> photos = ['images/clean2.jpg', 'images/clean1.jpg'];
  void _previousImage() {
    setState(() {
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Text(
                                Translations.of(context).cleaning_home_des,
                                style: TextStyle(
                            ...
                            Padding(
                              ...
                              child: Text(
                                Translations.of(context).cleaning_home_motv,
                                style: TextStyle(
                                    fontFamily: 'Montserrat',
                                    fontSize: 25.0,
                                    color: Colors.black,

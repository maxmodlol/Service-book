...
class Elecdetails extends StatefulWidget {
  int id;
  var user;
  Elecdetails(this.user, this.id);
  @override
  _MyDetails createState() => _MyDetails();
}

class _MyDetails extends State<Elecdetails> {
  ...
  int photoIndex = 0;
  List<String> photos = ['images/elec1.jpg', 'images/elec2.jpg'];
  void _previousImage() {
    setState(() {
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Text(
                                Translations.of(context).electrican_des,
                                style: TextStyle(
                            ...
                            Padding(
                              ...
                              child: Text(
                                Translations.of(context).electrican_motv,
                                style: TextStyle(
                                    fontFamily: 'Montserrat',
                                    fontSize: 25.0,
                                    color: Colors.black,
